...
namespace WebStore.Entities
{
    public partial class WebStoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=Webtore;Username=postgres;Password=qwerty123");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Address>(entity =>
            {
                ...
                entity.Property(e => e.AddressType).HasMaxLength(20).HasColumnName("address_type");
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.CustomerId).HasColumnName("customer_id");
                entity.Property(e => e.OrderDate).HasColumnType("timestamp without time zone").HasColumnName("order_date");
                ...
                // Additional Order fields (TrackingNumber, ShippedDate, DeliveredDate)
                entity.Property(o => o.TrackingNumber).HasColumnName("tracking_number").HasMaxLength(50);
                entity.Property(o => o.ShippedDate).HasColumnName("shipped_date");
                entity.Property(o => o.DeliveredDate).HasColumnName("delivered_date");
            });
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                ...
                entity.Property(e => e.Discount).HasPrecision(10, 2).HasColumnName("discount");
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                ...
                entity.Property(e => e.StoreId).HasColumnName("store_id");
                entity.Property(e => e.ProductId).HasColumnName("product_id");
                entity.Property(e => e.QuantityInStock).HasDefaultValue(0).HasColumnName("quantity_in_stock");
                entity.Property(e => e.UpdatedAt).HasColumnType("timestamp without time zone").HasColumnName("updated_at");
            ...
            modelBuilder.Entity<Carrier>(entity =>
            {
                ...
                entity.Property(e => e.CarrierName).HasMaxLength(50).HasColumnName("carrier_name");
                entity.Property(e => e.ContactUrl).HasMaxLength(50).HasColumnName("contact_url");
                entity.Property(e => e.ContactPhone).HasMaxLength(50).HasColumnName("contact_phone");

                entity.HasMany(c => c.Orders).WithOne(o => o.Carrier)
